...
public class frmMain extends javax.swing.JFrame {
    ...
    public void selectData() {
        String kolom[] = {"NIP","Nama","Jenis Kelamin","Mata Kuliah","Alamat"};
        DefaultTableModel dtm = new DefaultTableModel(null, kolom);
        String SQL = "SELECT * FROM t_dosen";
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sertifikasi BNSP");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if ("".equals(txtNIS.getText()) || "".equals(txtAlamat.getText()) || 
            ...
            String SQL = "INSERT INTO t_dosen (NIP,NamaDosen,JenisKelamin,Matkul,Alamat) "
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (baris != -1) {
            ...
            String SQL = "DELETE FROM t_dosen WHERE NIP='"+NIS+"'";
            int status = KoneksiDB.execute(SQL);
            if (status==1) {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if ("".equals(txtNIS.getText()) || "".equals(txtAlamat.getText()) || 
            ...
            String SQL = "UPDATE t_dosen SET "
                    + "NamaDosen='"+txtNama.getText()+"',"
                    + "JenisKelamin='"+JK+"',Matkul='"+txtKelas.getText()+"',"
                    + "Alamat='"+txtAlamat.getText()+"' "
                    + "WHERE NIP='"+txtNIS.getText()+"'";
            int status = KoneksiDB.execute(SQL);
            if (status == 1) {
